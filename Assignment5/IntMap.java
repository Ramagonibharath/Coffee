...
class IntMap implements java.io.Serializable {
  ...
  public static void main(String[] args) {
	  ...
	  sizefillargobj.put(18, 1);
	  sizefillargobj.put(22, 2);
	  sizefillargobj.put(63, 4);
	  ...
	  System.out.println("Key value in IntMap: " + sizeargobj.get(26));
	  sizeargobj.put(26, 3);
	  System.out.println("Key value of key post modification: " + sizeargobj.get(26));
	  System.out.println("Key present?(in IntMap): " + sizeargobj.contains(27));
	  System.out.println("Accessing key not in map: " + sizeargobj.get(27));
	  System.out.println("Check if key in map: " + sizeargobj.contains(26));
	  System.out.println("Can existing key be added?:" + sizeargobj.add(26));
	  sizeargobj.add(27);
