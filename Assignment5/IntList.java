...
class IntList {
 ...
 public static void main(String args[]){
	  ...
	  IntList headEle = new IntList(50);
	  IntList curList = new IntList(100, headEle);
	  System.out.println("Elements are: "+ curList.toString());
	  ...
	  System.out.println("Added List using cons " + IntList.cons(70, curList));
	  System.out.println("List by adding arrays: "+ IntList.app(new int[]{10,20,30}, curList));
