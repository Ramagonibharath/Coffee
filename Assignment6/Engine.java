...
class Engine {
  ...
  Engine(final String fname) {
    ...
    clauses = dload(fname);
    // System.out.println(" HEAP AFTER DLOAD " + Arrays.toString(heap).substring(0,300));
    cls = toNums(clauses); 
    query = init();
  ...
  final HashMap<String, Integer> syms;
  ...
  */
  ...
  Clause[] dload(final String s) {
    ...
    for (final ArrayList<ArrayList<String>> Wss : Wsss) {
      ...
      final HashMap<String, IntStack> refs = new HashMap<String, IntStack>();
      ...
      for (final String[] ws : Rss) {
        ...
        for (String w : ws) {
          ...
          switch (w.charAt(0)) {
            ...
            //  System.out.println(Arrays.toString(refs.entrySet().toArray()));
              if (null == Is) { 
                Is = new IntStack();
                refs.put(L, Is);
              }
   ...
   // System.out.println(" HEAP AFTER FOR LOOPS IN DLOAD " + Arrays.toString(heap).substring(0,300));
      ...
      while (K.hasNext()) {
        ...
        if (-1 == leader) {
          ...
          for (final int i : Is.toArray()) {
            if (i == leader) {  
              cs.set(i, tag(V, i));
              // if(i == 14 || i == 17) System.out.println(" /// " + i + " TAG " + tag(V,i));
      ...
      // System.out.println(" TGS " + Arrays.toString(tgs));
  ...
  */
  ...
  final private Spine unfold(final Spine G) {
   ...
   // System.out.println("TTOP G" + G.ttop + " BASE " + G.base+ " GOAL " + goal + " G GS "  + G.gs.toString() );
  ...
  public static void main(String[] args) {
	  ...
	  final String fname = "C:\\Users\\Bomule\\Desktop\\perms.pl" ;
	  Engine obj = new Engine(fname);
	  System.out.println("Len(Heap):" + obj.heap.length);
	  System.out.println("Clauses Array: "+ Arrays.toString(obj.clauses));
	  System.out.println("Clause Array with elements = 'Clause' :" + Arrays.toString(obj.cls));
	  System.out.println("Symbol_LIST:" + obj.slist);
	  System.out.println("Symbol_MAP:" + obj.syms);
	  System.out.println("ObStack_SPINE:"+(obj.spines));
	  System.out.println("Spine_QUERY:" + obj.query);
	  System.out.println("IntMap ARRAY:"+ Arrays.toString(obj.vmaps));
	  System.out.println("IMap INTEGER Array: "+ Arrays.toString(obj.imaps));
	  obj.run();
}
